...
const FormCompra = () => {
  const { cart, modal, totalCart,resetCart,activarModal } = useContext(CartGlobalContext);
  ...
  const handleSubmit = (e) => {
      ...
      const productos = cart.map((cartZap) => (
        {productId: cartZap._id, quantity: 1}
      )) 
      const newOrden = {
        productos: [...productos],   
        total: totalCart,
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <p>
        ...
        consignada.
        <br />
        Se acepta la devolución de la mercadería hasta 48hs luego de la compra,
        el gasto de envio de la devolución corre por cuenta del cliente.
        <br />
        Al presionar el boton comprar acepta los términos y condiciones
        expuestos y solo en caso de pago efectuado se reserva la mercaderia para
        su envío.
      </p>
